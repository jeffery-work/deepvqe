...
from Utility.AudioLib import AudioWrite
plt.switch_backend("agg")

# speech enhancement trainer
class SpeechEnhancementTrainer(BaseTrainer):
    def __init__(
            self,
            config,
            resume: bool,
        ...
        super(SpeechEnhancementTrainer, self).__init__(config, resume, model, optimizer, loss_function)
